...
const CONFIGS: Record<BusinessType, BusinessUIConfig> = {
  ...
  DENTAL: {
    ...
    categoryLabel: "Area",
    skuLabel: "Codigo",
    unitLabel: "Presentacion",
    stockLabel: "Stock",
    variantLabel: "Variantes",
    supplierLabel: "Proveedor dental",
    searchPlaceholder: "Buscar por insumo, codigo o lote...",
    namePlaceholder: "ej: Resina A2, Guantes nitrilo, Anestesia",
    unitPlaceholder: "ej: caja, frasco, kit, unidad",
    unitOptions: ["caja", "frasco", "unidad", "kit", "paquete", "bolsa", "ampolla", "cartucho", "ml", "g"],
    attrPlaceholders: { presentacion: "ej: Caja x100, Frasco 5ml", area: "ej: Bioseguridad, Ortodoncia" },
    showBatchExpiry: true,
    showBarcode: true,
    showUnit: true,
    ...
    posVariantHint: "Selecciona presentacion y area",
    sidebarLabels: { inventory: "Inventario Dental", categories: "Areas de Insumos", suppliers: "Proveedores Dentales" },
    extraSections: [{ href: "/inventory?vencimientos=1", label: "Vencimientos", minPlan: "CRECER" }],
  },
  FERRETERIA: {
