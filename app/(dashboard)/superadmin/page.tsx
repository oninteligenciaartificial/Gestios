...
export default async function SuperAdminPage() {
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-8">
      ...
      <section className="kpi-grid grid grid-cols-2 lg:grid-cols-5 gap-4">
        {kpis.map((kpi) => (
          <div key={kpi.label} className="glass-panel p-5 rounded-2xl animate-pop hover:-translate-y-1 transition-transform duration-300">
      ...
      <section className="space-y-4 animate-pop">
        <div className="flex justify-between items-center">
          <h2 className="text-xl font-display font-bold text-white">Tiendas <span className="text-brand-kinetic-orange ml-2">•</span></h2>
